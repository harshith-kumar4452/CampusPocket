...
sql_query = """
SELECT * FROM public.student_parents WHERE parent_id = '36bbc751-6b06-462f-85e2-f76b7213800a';
"""
...
print("Checking student_parents table...")
...
if stderr:
    ...
    print("DB checked. See db_check_result.json")
